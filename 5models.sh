...
files=(
    ...
    #129MB flux1-redux-dev.safetensors, 需手动下载上传
    #"flux1-redux-dev.safetensors | https://huggingface.co/black-forest-labs/FLUX.1-Redux-dev/resolve/main/flux1-redux-dev.safetensors?download=true |  ${basefolder}/ComfyUI/models/style_models"
