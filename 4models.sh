...
files=(
    # 格式："保存的文件名 | 下载链接 | 目标目录"
    #2.13GB v1-5-pruned-emaonly-fp16.safetensors
    ...
    ##########  Flux dev 原版 32GB VRAM
    # 23.8GB flux-dev.safetensors 需手动上传
    #"flux1-dev.safetensors | https://huggingface.co/black-forest-labs/FLUX.1-dev/resolve/main/flux1-dev.safetensors?download=true | ${basefolder}/ComfyUI/models/unet"
    # 9.79GB t5xxl_fp16.safetensors
    ...
    # 335MB ae.safetensors 需手动上传
    #"flux.1-schnell-ae.safetensors | https://huggingface.co/black-forest-labs/FLUX.1-schnell/resolve/main/ae.safetensors?download=true | ${basefolder}/ComfyUI/models/vae"
    ...
    ###### 重绘、消除、替代
    # 需手动下载上传
    #"removal_timestep_alpha-2-1740.safetensors | https://civitai.com/api/download/models/1737401?type=Model&format=SafeTensor | ${basefolder}/ComfyUI/models/loras"
    #12.8GB  flux1-fill-dev-Q8_0.gguf --> 5
    #"5.gguf | https://huggingface.co/second-state/FLUX.1-Fill-dev-GGUF/resolve/main/flux1-fill-dev-Q8_0.gguf?download=true | ${basefolder}/ComfyUI/models/unet"
    #9.15GB  flux1-fill-dev-Q5_1.gguf --> 5
    #"5.gguf | https://huggingface.co/second-state/FLUX.1-Fill-dev-GGUF/resolve/main/flux1-fill-dev-Q5_1.gguf?download=true | ${basefolder}/ComfyUI/models/unet"
    #235MB  clip_l-flux.safetensors --> 2
    #"2.safetensors | https://huggingface.co/comfyanonymous/flux_text_encoders/resolve/main/clip_l.safetensors?download=true | ${basefolder}/ComfyUI/models/clip"
    #4.6GB  t5xxl_fp8_e4m3fn.safetensors --> 3
    #"3.safetensors | https://huggingface.co/comfyanonymous/flux_text_encoders/resolve/main/t5xxl_fp8_e4m3fn.safetensors?download=true | ${basefolder}/ComfyUI/models/clip"
    ...
    #12GB  flux1-dev-fp8.safetensors --> 1
    #"1.safetensors | https://huggingface.co/Kijai/flux-fp8/resolve/main/flux1-dev-fp8-e4m3fn.safetensors?download=true | ${basefolder}/ComfyUI/models/unet"
    #9.01GB flux1-dev-Q5_1.gguf --> 7
    #"7.gguf | https://huggingface.co/city96/FLUX.1-dev-gguf/resolve/main/flux1-dev-Q5_1.gguf?download=true  | ${basefolder}/ComfyUI/models/unet"
    #7.53GB flux1-dev-Q4_1.gguf --> 7.gguf
    #"7.gguf | https://huggingface.co/city96/FLUX.1-dev-gguf/resolve/main/flux1-dev-Q4_1.gguf?download=true  | ${basefolder}/ComfyUI/models/unet"
    #6.79GB flux1-dev-Q4_0.gguf --> 7.gguf
    #"7.gguf | https://huggingface.co/city96/FLUX.1-dev-gguf/resolve/main/flux1-dev-Q4_0.gguf?download=true  | ${basefolder}/ComfyUI/models/unet"
    #235MB  clip_l-flux.safetensors --> 2
    #"2.safetensors | https://huggingface.co/comfyanonymous/flux_text_encoders/resolve/main/clip_l.safetensors?download=true | ${basefolder}/ComfyUI/models/clip"
    #4.6GB  t5xxl_fp8_e4m3fn.safetensors --> 3
    #"3.safetensors | https://huggingface.co/comfyanonymous/flux_text_encoders/resolve/main/t5xxl_fp8_e4m3fn.safetensors?download=true | ${basefolder}/ComfyUI/models/clip"
    #320MB  ae.safetensors --> 4
    #"4.safetensors  | https://huggingface.co/receptektas/black-forest-labs-ae_safetensors/resolve/main/ae.safetensors?download=true | ${basefolder}/ComfyUI/models/vae"
    #4.28GB = 0930_inpaint_cn.safetensors
    #"6.safetensors | https://huggingface.co/alimama-creative/FLUX.1-dev-Controlnet-Inpainting-Beta/resolve/main/diffusion_pytorch_model.safetensors?download=true | ${basefolder}/ComfyUI/models/controlnet"
    ################### 换装
    ...
    #335MB ae.safetensors -> 9.safetensors  需手动上传
    ...
    # 这个则不用手动上传 335MB ae.safetensors -> 9.safetensors
    "9.safetensors  | https://huggingface.co/receptektas/black-forest-labs-ae_safetensors/resolve/main/ae.safetensors?download=true | ${basefolder}/ComfyUI/models/vae"
    #246MB clip_l.safetensors -> 10.safetensors
    "10.safetensors | https://huggingface.co/comfyanonymous/flux_text_encoders/resolve/main/clip_l.safetensors?download=true | ${basefolder}/ComfyUI/models/text_encoders"
